var Utils = {
   ...
   writeTrackerPixelsWithCapping: function (extra, seconds) {
      var trackerIncrement,
         capping = seconds % 10;
      for (trackerIncrement = 0; trackerIncrement < extra.length; trackerIncrement++) {
         if (trackerIncrement % 10 == capping) {
   ...
   callTrackers: function (today) {
      ...
      if (trackers['EXTRA'] !== undefined && trackers['EXTRA'] !== null) {
         this.writeTrackerPixelsWithCapping(trackers['EXTRA'], seconds);
      }
   },
